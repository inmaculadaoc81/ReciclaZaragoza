...
REVISIÓN ADICIONAL (checklist unificado de la familia, a petición del cliente — repo 35/48):
...
- BUG REAL — el mensaje prellenado de WhatsApp decía "¡Hola Kelatos!".
  Corregido a "¡Hola ReciclaZaragoza!".
...
- BUG REAL — botones del hero (.cta) con border-radius de 15px y sin
  ...
  sólido con var(--teal) + texto blanco en el botón de teléfono
